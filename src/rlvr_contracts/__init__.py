"""Shared runtime contracts for Arabic reasoning SFT / RLVR / synthetic data.

Generation acceptance and training rewards MUST use identical parsers,
answer_spec canonicalization, and verifiers from this package.
"""
...
from rlvr_contracts.verifiers import (
