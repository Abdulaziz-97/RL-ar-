...
Usage:
    ...
    python -m rlvr_sota train --config configs/qwen_4b_qlora.yaml
    python -m rlvr_sota eval  --config configs/qwen_4b_qlora.yaml --data data/eval.jsonl --checkpoint outputs/
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="rlvr_sota",
        description="SOTA Arabic Reasoning RLVR Pipeline (TRL GRPOTrainer + QLoRA)",
    )
